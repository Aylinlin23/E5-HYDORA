...
import { MapPinIcon, DocumentIcon, CalendarIcon, MapIcon } from '../ui/Icons';
...
interface MapFilters {
  status: 'all' | 'PENDING' | 'IN_PROGRESS' | 'RESOLVED' | 'REJECTED';
  priority: 'all' | 'LOW' | 'MEDIUM' | 'HIGH' | 'URGENT';
  assignedTo: 'all' | 'me' | 'others' | 'unassigned';
  proximity: 'all' | '1km' | '5km' | '10km';
  showHeatmap: boolean;
...
const AdvancedMapPage: React.FC = () => {
      ...
      const mockReports: MapReport[] = [
        {
          ...
          description: 'Fuga importante en la esquina de Reforma y Juárez.',
          status: 'PENDING',
          priority: 'HIGH',
          latitude: 19.4326,
          longitude: -99.1332,
        ...
        },
        {
          ...
          description: 'La alcantarilla está desbordándose.',
          status: 'IN_PROGRESS',
          priority: 'URGENT',
          latitude: 19.4000,
          longitude: -99.1500,
        ...
        },
        {
          ...
          description: 'Pequeña fuga en el sistema de riego.',
          status: 'RESOLVED',
          priority: 'LOW',
          latitude: 19.4200,
          longitude: -99.1200,
  ...
  const handleReportClick = (report: MapReport) => {
        ...
        {selectedReport && (
          <div style={{
            ...
            <p style={{
              ...
              <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <CalendarIcon /> {new Date(selectedReport.createdAt).toLocaleDateString()}
              </span>
            </p>
