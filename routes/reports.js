 ...
 *         schema:
 *           type: string
 *         description: Buscar en título, descripción o dirección
 *     responses:
 *       200:
...
// Cancelar reporte (propietario puede cancelar si aún está PENDING)
router.post('/:id/cancel', authenticateToken, ReportController.cancel);
...
/**
 * @swagger
 * /api/reports/stats/dashboard:
 *   get:
 *     summary: Obtener estadísticas detalladas para dashboard (solo autoridades y admins)
 *     tags: [Reportes]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *         description: Solo autoridades y admins pueden ver estadísticas
 */
router.get('/stats/dashboard', authenticateToken, authorizeRoles('AUTHORITY', 'ADMIN'), ReportController.getDashboardStats);
